...
> **Disclaimer**: This is mostly opinion, and only my opinion. This post is not associated with my employer in any way. You can contact me on Mastodon [@kn100@fosstodon.org](https://fosstodon.org/@kn100)
...
{{< figure src="/posts/breaking-go/intro.png" alt="A screenshot of the Github Releases page for 'pusher-http-go'" caption="The releases page on Github looks a bit ridiculous." >}}
